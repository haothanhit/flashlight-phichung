package com.haohao.camposer.extensions
...
import com.haohao.camposer.state.VideoCaptureResult
 ...
 * */
suspend fun CameraState.takePicture(file: File): Uri? = suspendCancellableCoroutine { cont ->
